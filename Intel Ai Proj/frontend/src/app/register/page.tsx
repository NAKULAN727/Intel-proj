    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-slate-950 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white font-poppins mb-2">Create Account</h1>
          <p className="text-slate-400">Join NexusRAG for enterprise intelligence</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            disabled={loading}
            className="w-full relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 p-[1px] group mt-6"
          >
            ...
            <div className="relative bg-slate-900/20 backdrop-blur-sm rounded-xl py-3.5 flex justify-center items-center transition-all group-hover:bg-transparent">
              {loading ? (
                ...
                <span className="text-white font-medium flex items-center">
                  Create Account <UserPlus className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                </span>
              )}
            </div>
          </button>
        ...
        <p className="text-center text-slate-400 text-sm mt-8">
          Already have an account? <Link href="/login" className="text-indigo-400 hover:text-indigo-300 font-medium ml-1">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
